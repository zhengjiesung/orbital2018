...
public class CashflowsFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_cashflows3, null);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        BarDataSet barDataSet = new BarDataSet(MainActivity.barEntries4, "Cash Inflows");
        barDataSet.setColors(Color.rgb(254, 247, 120));

        BarDataSet barDataSet1 = new BarDataSet(MainActivity.barEntries5, "Cash Outflows");
        ...
        String[] months = new String[] {MainActivity.prev11Month,"blank",MainActivity.prev10Month + " " + MainActivity.prev9Month,"blank",MainActivity.prev8Month + " " + MainActivity.prev7Month, "blank" ,MainActivity.prev6Month + " " + MainActivity.prev5Month,"blank1", MainActivity.prev4Month + " " + MainActivity.prev3Month, "blank3", MainActivity.prev2Month + " " + MainActivity.prevMonth, "blank5", MainActivity.currMonth ,"blank7",MainActivity.prevMonth + " " +  MainActivity.currMonth , "blank9"};
